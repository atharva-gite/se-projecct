...
//const ExpressError = require('<path-to-ExpressError>');
const app = express();
...
const dbUrl = process.env.DB_URL || 'mongodb+srv://atharva:pkY76XU2!LbU3Wb@cluster0.puvwt8t.mongodb.net/test';
console.log(dbUrl);
...
async function main() {
  await mongoose.connect('mongodb+srv://atharva:pkY76XU2!LbU3Wb@cluster0.puvwt8t.mongodb.net/test');
}
